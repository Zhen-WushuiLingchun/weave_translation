...
织语采用洁净室架构和原创界面。以下项目仅用于研究公开的交互或平台字幕获取方法；当前仓库未直接复制其源文件。若未来引入代码，必须在本文件中追加具体文件、固定 commit、修改说明和对应许可证文本。

| Project | License | Inspected commit | Use in Weave |
| --- | --- | --- | --- |
| [OpenRead](https://github.com/uxgnod/openread) | Apache-2.0 | `dd606d002f9f319b691a3066d56b2d3d16e7d4a9` | Full-page and selection translation product research only |
